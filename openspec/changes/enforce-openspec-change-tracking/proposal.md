...
- Require strict OpenSpec validation before a change is treated as complete or synchronized for collaborators.
...
- Keep GitHub issues, feature branches, and pull requests optional for the time-boxed hackathon workflow.
...
- Updates `README.md` and `AGENTS.md` with the mandatory lightweight OpenSpec lifecycle.
